...
Revision ID: b7122822039d
Revises: 
Create Date: 2024-03-16 10:33:03.201770
...
def upgrade():
    ...
    sa.Column('followed_users', sa.Integer(), nullable=True),
    sa.Column('users_following_me', sa.Integer(), nullable=True),
